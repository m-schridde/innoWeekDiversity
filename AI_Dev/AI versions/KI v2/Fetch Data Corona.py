...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Corona")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Corona")


irrelevant, links = FilterLinks.get_links(0, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "XXXXXX")
comments = []
