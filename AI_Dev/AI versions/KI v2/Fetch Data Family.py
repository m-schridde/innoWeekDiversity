...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Family")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Family")


irrelevant, links = FilterLinks.get_links(1, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "XXXXXX")
comments = []
