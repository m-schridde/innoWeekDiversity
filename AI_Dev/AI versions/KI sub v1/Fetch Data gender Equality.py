...
REPLY_COMMENT_THRESHHOLD = 20
TRAINIG_DATA_PORTION = 0.85
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Gender Equality")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Gender Equality")


links, irrelevant = FilterLinks.get_links(1, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "Gender Equality")
comments = []
