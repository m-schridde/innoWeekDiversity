...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","LGBTQ+")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","LGBTQ+")


links, irrelevant = FilterLinks.get_links(2, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "LGBTQ+")
comments = []
