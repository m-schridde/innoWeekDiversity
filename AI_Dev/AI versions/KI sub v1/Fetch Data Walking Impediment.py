...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Walking Impediment")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Walking Impediment")


links, irrelevant = FilterLinks.get_links(4, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "walking impediment")
comments = []
