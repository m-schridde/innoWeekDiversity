...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Visually Impaired")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Visually Impaired")


links, irrelevant = FilterLinks.get_links(4, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "visually impaired")
comments = []
