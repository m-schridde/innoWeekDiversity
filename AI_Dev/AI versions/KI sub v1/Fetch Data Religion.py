...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Religion")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Religion")


links, irrelevant = FilterLinks.get_links(3, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "Religion")
comments = []
