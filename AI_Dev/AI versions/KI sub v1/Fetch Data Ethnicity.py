...
TRAINING_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Training","Ethnicity")
TEST_DATA_PATH = os.path.join(os.path.dirname(__file__), "Data","Test","Ethnicity")


links, irrelevant = FilterLinks.get_links(3, "C:\\Users\\I518091\\OneDrive - SAP SE\\Schulungen\\Innoweek\\Threads.xlsx", "Ethnicity")
comments = []
